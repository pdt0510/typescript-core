...
tạo 1st decorator file named 'entity', nơi đây sẽ cấu hình các decorator metadata, see entity.ts + xx6

export function entity... -> define and storing name of entity, this value sẽ dùng để set baseURL (parent route) for entity (class).
...
db.push(`/${this.className}/${newEntity[idProperty]}`, ...; -> db.push(dataPath, , data) <=>  POST http

như đã nói (v3-32ss), dataPath string là sẽ bắt đầu với baseURL
