...
class EntityRouter {
    ...
    constructor(className, classRef) {
        ...
        this._router = express_1.default.Router(); //create the router for an object
    ...
    createEntity(req, res) {
        ...
        const idProperty2 = Reflect.getMetadata('entity:id', this.classRef);
        console.log('idProperty ---', idProperty);
        console.log('idProperty 2 ---', idProperty2);
        newEntity[idProperty] = uuid.v4();
        console.log('newEntity 2 ---', newEntity);
        // db.push(`/${this.className}/${newEntity[idProperty]}`, newEntity.getPersistenceObject()); //POST
        app_1.db.push(`/${this.className}`, newEntity.getPersistenceObject()); //POST
